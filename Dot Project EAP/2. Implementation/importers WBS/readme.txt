...
*  WBS Gant Chart Pro v4.4 - other versions may be supported, this specific 
...
*  Fixed a major issue where dependencies weren't being imported properly or
sometimes at all.
